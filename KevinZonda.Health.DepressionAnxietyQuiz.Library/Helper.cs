...
namespace KevinZonda.Health.DepressionAnxietyQuiz.Library
{
    public static class Helper
    {
        ...
        public static string GetResultByDepressionScore(int v)
        {
            if (v < 10)
                return "根据你对问题1-8的回答，你没有遇到许多抑郁症的症状。" +
            ...
            if (v < 19)
                return "根据你对问题1-8的回答，你正经历着一些抑郁症的症状，但只有有经验的健康专家才能确定。\n" +
        ...
        public static string GetResultByAnxietyScore(int v)
        {
            if (v == 0)
                return "根据你对问题10-16的回答，你没有出现任何焦虑的症状。" +
            ...
            if (v < 6)
                return "根据你对问题10-16的回答，你正经历着一些焦虑症的症状。不时感到焦虑或担心是非常正常的。" +
            ...
            if (v < 11)
                return "根据你对问题10-16的回答，你正经历着一些焦虑症的症状。" +
